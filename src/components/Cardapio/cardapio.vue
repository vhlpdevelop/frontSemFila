<template>
  <v-app style="background-color: #100c08 !important">
    ...
    <v-app-bar app  class="backgroundB elevation-12 ml-1 mr-1">
            ...
            <v-list shaped>
              <v-list-item-group>
                <v-list-item @click="toLink('checkout')" color="primary">
                  ...
                  <v-list-item-content>
                    <v-list-item-title v-text="'Pagar'"></v-list-item-title>
                  </v-list-item-content>
                </v-list-item>
                <v-divider></v-divider>
              </v-list-item-group>
    ...
    <v-navigation-drawer app v-model="drawer" temporary width="300" class="mx-auto">
      <v-list class="">
        <v-list-item>
  ...
  item.icon
    ...
    <v-container v-if="loaded" mt-12 ma-0 pr-0 pl-0 pt-3 fluid class="mx-auto">
